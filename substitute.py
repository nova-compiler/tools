...
def substitute_text(contents, context):
...
def substitute_file(input_file_path, output_file_path, context_file):
	with open(input_file_path, 'r') as input_file:
		...
		processed_output = substitute_text(contents, context)
...
def read_arguments(args):
	...
	try:
		opts, args = getopt.getopt(args, 'i:o:c:', [ 'input=', 'output=', 'context=' ])
		for opt, arg in opts:
			if opt in ('-i', '--input'):
				input_file = arg
	...
	return input_file, output_file, context_file
...
def main(args):
	try:
		input_file, output_file, context_file = read_arguments(args)
	...
	substitute_file(input_file, output_file, context_file)
